# Don't Remove Credit Tg - @Unknown0125
# Ask Doubt on telegram @Unknown0125
...
OWNER_ID = 6643289556 # Replace with the actual owner's user ID
...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ🇮🇳" ,url=f"https://t.me/MrUnknown1920_bot") ],
                    [
                    InlineKeyboardButton("🔔ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ🔔" ,url="https://t.me/MrUnknown1920_bot") ],
                    [
                    InlineKeyboardButton("🦋ғᴏʟʟᴏᴡ ᴜs🦋" ,url="https://t.me/MrUnknown1920_bot")                              
                ],           
            ]
      )
...
@bot.on_message(filters.command(["Unknown"]))
async def upload(bot: Client, m: Message):
    ...
    credit = "️[Unknown�](https://t.me/MrUnknown1920_bot)"
    if raw_text3 == '1':
        CR = '[Unknown�](https://t.me/MrUnknown1920_bot)'
    elif raw_text3:
        try:
